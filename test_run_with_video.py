...
# -*- coding: utf-8 -*-
#
# Author: Marvin Teichmann + Anthony playing around with it
...
def process_image(input_image):
    ...
    image = scp.misc.imresize(input_image, (hypes["image_height"],
                                      hypes["image_width"]),
                              interp='cubic')
...
def main(_):
    ...
    clip.write_videofile('test_videos/project_video_finished.mp4', audio=False)
